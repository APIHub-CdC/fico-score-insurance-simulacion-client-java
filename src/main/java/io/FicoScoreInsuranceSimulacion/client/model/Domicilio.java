...
public class Domicilio {
  ...
  @ApiModelProperty(example = "HIDALGO 32", value = "Calle y número del domicilio")
  ...
  @ApiModelProperty(example = "47917", value = "Código postal al que pertenece el domicilio")
  ...
  @ApiModelProperty(example = "LA BARCA", value = "Municipio en que se ubica el domicilio")
